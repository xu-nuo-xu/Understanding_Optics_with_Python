...
# Form implementation generated from reading ui file 'Ui_Fresnel1Slit.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_Lambda, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.SpinBox_D, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.SpinBox_Lambda, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.Slider_D, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.Slider_Lambda, 1, 3, 1, 1)
        self.label_B = QtWidgets.QLabel(self.centralWidget)
        self.label_B.setObjectName("label_B")
        self.gridLayout.addWidget(self.label_B, 0, 0, 1, 1)
        ...
        self.SpinBox_B.setMaximum(10000.0)
        self.SpinBox_B.setProperty("value", 1050.0)
        self.SpinBox_B.setObjectName("SpinBox_B")
        self.gridLayout.addWidget(self.SpinBox_B, 0, 1, 1, 1)
        ...
        self.Slider_B.setMaximum(10000)
        self.Slider_B.setSingleStep(10)
        self.Slider_B.setPageStep(100)
        self.Slider_B.setProperty("value", 1050)
        self.Slider_B.setOrientation(QtCore.Qt.Horizontal)
        self.Slider_B.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.Slider_B.setTickInterval(200)
        self.Slider_B.setObjectName("Slider_B")
        self.gridLayout.addWidget(self.Slider_B, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Fresnel Slit"))
        ...
        self.label_B.setText(_translate("MainWindow", "Slit width (micron)"))
