...
# Form implementation generated from reading ui file 'Ui_NewtonRings.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SpinBox_Lambda1.setMinimum(430.0)
        self.SpinBox_Lambda1.setMaximum(519.0)
        self.SpinBox_Lambda1.setSingleStep(0.1)
        self.SpinBox_Lambda1.setProperty("value", 470.0)
        ...
        self.SpinBox_Lambda2.setProperty("value", 545.0)
        ...
        self.SpinBox_R = QtWidgets.QDoubleSpinBox(self.centralWidget)
        self.SpinBox_R.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.SpinBox_R.setSuffix("")
        self.SpinBox_R.setDecimals(2)
        self.SpinBox_R.setMinimum(0.0)
        self.SpinBox_R.setMaximum(50.0)
        self.SpinBox_R.setSingleStep(0.1)
        self.SpinBox_R.setProperty("value", 20.0)
        self.SpinBox_R.setObjectName("SpinBox_R")
        self.gridLayout_2.addWidget(self.SpinBox_R, 1, 2, 1, 1)
        ...
        self.SpinBox_e.setMaximum(10.0)
        self.SpinBox_e.setSingleStep(0.01)
        self.SpinBox_e.setProperty("value", 0.0)
        ...
        self.gridLayout_2.addWidget(self.label_R, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Newton Rings"))
        ...
        self.label_e.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#000000;\">Contact distance (µm)</span></p></body></html>"))
        self.label_R.setText(_translate("MainWindow", "Lens radius (cm)"))
